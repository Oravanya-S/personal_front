...
//update categories
export const getGroupColorWithColor = () => axios.get('/admin/groupcolorwithcolor');
...
export const getDashboard = async ({startDate, endDate}) => axios.get(`/admin/dashboard?startDate=${startDate}&endDate=${endDate}`);
...
export const deleteColour = async (colorId) => await axios.delete(`/admin/colour/${colorId}`);
...
export const createColour = async (newColorObj) => await axios.post('/admin/colour', newColorObj);
...
export const updateColour = async (colorId, updateColorObj) => await axios.put(`/admin/colour/${colorId}`, updateColorObj);
