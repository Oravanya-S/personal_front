import {createPortal} from 'react-dom'
  export default function Modal({children, open, onClose, width = '5/12', position = 'justify-end', ptpx = '120px', z='30'}) {
        ...
        <>
          ...
          <div className={`flex ${position} min-h-full`}>
            ...
            onMouseUp={e => e.stopPropagation()}>
              <div className='flex justify-end text-xl top-[120px] right-14 absolute xl:right-20'>
